...
templates['global_header'] = template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [2,'>= 1.0.0-rc.3'];
helpers = helpers || Handlebars.helpers; data = data || {};
  var buffer = "", stack1, options, functionType="function", escapeExpression=this.escapeExpression, helperMissing=helpers.helperMissing;


  buffer += "<a class=\"top-nav wm-logo\" href=\"http://www.walmart.com\">Walmart</a>\n<form class=\"top-nav\" action=\"/\">\n    <input type=\"text\" class='search-box' name=\"search\" placeholder=\"Search\" title=\"Search Walmart.com\">\n</form>\n\n<ul class=\"top-nav\" id=\"nav-buttons\">\n    <li><a href=\"\" class=\"button\"><span class=\"create\">Create</span><span class=\"txt\">a new wishlist</span></a></li>\n    <li><a href=\"\" class=\"button\"><span class=\"signin\">Sign In</span><span class=\"txt\">to your account</span></a></li>\n    <li><a href=\"\" class=\"button open-cart\"><span class=\"cart\">";
  if (stack1 = helpers.itemCount) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.itemCount; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + " Item";
  options = {hash:{},data:data};
  buffer += escapeExpression(((stack1 = helpers.pluralize),stack1 ? stack1.call(depth0, depth0.itemCount, options) : helperMissing.call(depth0, "pluralize", depth0.itemCount, options)))
    + "</span><span class=\"txt\">in your cart</span></a></li>\n</ul>";
  return buffer;
  });
